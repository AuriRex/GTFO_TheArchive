...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static string DecimalPercantageToTraitPercentage(float decimalPercentage)
        {
            return BoosterImplant.DecimalPercantageToTraitPercentage(decimalPercentage);
        }
        public static string GetCompositPublicName(BoosterImplantCategory cat, uint templateId, uint effectDataBlockId, uint conditionDataBlockId, bool shortVersion = false)
        {
            return BoosterImplant.GetCompositPublicName(cat, templateId, effectDataBlockId, conditionDataBlockId, shortVersion);
        }
        public string GetCompositPublicName(bool shortVersion = false)
        {
