...
{
    public class OldLocalProgressionManager : InitSingletonBase<OldLocalProgressionManager>, IInitAfterGameDataInitialized
    {
#warning TODO: Artifact Heat for R5
        ...
        public static class ProgressionMerger
        {
            ...
            {
                MergeIntoLocalRundownProgression(OldLocalProgressionManager.Instance.CurrentActiveSession);
            }
