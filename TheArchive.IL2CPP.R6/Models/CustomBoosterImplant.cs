...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void SetToDropServerBaseGame(ref DropServer.BoosterImplants.BoosterImplantBase implant)
        {
        ...
        protected DropServer.BoosterImplants.BoosterImplantInventoryItem ToBaseGameInventoryItem()
        {
            var biii = (DropServer.BoosterImplants.BoosterImplantBase) new DropServer.BoosterImplants.BoosterImplantInventoryItem(ClassInjector.DerivedConstructorPointer<DropServer.BoosterImplants.BoosterImplantInventoryItem>());

            SetToDropServerBaseGame(ref biii);

            return (DropServer.BoosterImplants.BoosterImplantInventoryItem) biii;
        }
