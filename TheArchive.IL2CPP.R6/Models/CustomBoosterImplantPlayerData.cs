...
using static DropServer.BoosterImplants.BoosterImplantPlayerData;
    ...
    public class CustomBoosterImplantPlayerData
    {
        ...
        public class CustomCategory
        {
            ...
            public Category ToBaseGame()
            {
                ...
                cat.Inventory = new UnhollowerBaseLib.Il2CppReferenceArray<DropServer.BoosterImplants.BoosterImplantInventoryItem>(Inventory.Length);
                for(int i = 0; i < Inventory.Length; i++)
                {
