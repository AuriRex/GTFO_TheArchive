...
/// <summary>
/// Identifies a method defined in a <c>ArchivePatch</c> type to be the postfix method.<br/>
/// It runs after the original methods code is run.
/// </summary>
...
/// <item>Alternatively, name your method <c>Postfix</c> to avoid having to use this attribute.</item>
...
public class IsPostfix : Attribute
{
}