...
/// <summary>
/// Identifies a method defined in a <c>ArchivePatch</c> type to be the method that provides the name of the method to patch.
/// </summary>
...
/// <item>Alternatively, name your method <c>MethodName</c> to avoid having to use this attribute.</item>
...
public class IsMethodNameProvider : Attribute
{
}