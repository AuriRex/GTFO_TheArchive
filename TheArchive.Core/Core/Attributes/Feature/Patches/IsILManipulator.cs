...
/// <summary>
/// Identifies a method defined in a <c>ArchivePatch</c> type to be the il-manipulator method.<br/>
/// Manipulates the IL of the original method.<br/>
/// <a href="https://github.com/BepInEx/HarmonyX/wiki/ILManipulators">HarmonyX ILManipulator Documentation</a>
/// </summary>
...
/// <item>Alternatively, name your method <c>ILManipulator</c> to avoid having to use this attribute.</item>
...
public class IsILManipulator : Attribute
{
}