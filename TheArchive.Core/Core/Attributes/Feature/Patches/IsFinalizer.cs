...
/// <summary>
/// Identifies a method defined in a <c>ArchivePatch</c> type to be the finalizer method.<br/>
/// It runs after all prefixes and postfixes have run.
/// </summary>
...
/// <item>Alternatively, name your method <c>Finalizer</c> to avoid having to use this attribute.</item>
...
public class IsFinalizer : Attribute
{
}