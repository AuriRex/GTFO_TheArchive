...
/// <summary>
/// Identifies a method defined in a <c>ArchivePatch</c> type to be the method that provides the parameter types of the method to patch.
/// </summary>
...
/// <item>Alternatively, name your method <c>ParameterTypes</c> to avoid having to use this attribute.</item>
...
public class IsParameterTypesProvider : Attribute
{
}