...
/// <summary>
/// Identifies a method defined in a <c>ArchivePatch</c> type to be the prefix method.<br/>
/// It runs before the original methods code is run.
/// </summary>
...
/// <item>Alternatively, name your method <c>Prefix</c> to avoid having to use this attribute.</item>
...
public class IsPrefix : Attribute
{
}