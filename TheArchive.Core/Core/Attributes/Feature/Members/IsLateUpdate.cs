...
/// <summary>
/// Identifies a method defined in a <see cref="FeaturesAPI.Feature"/> type to be the <see cref="FeaturesAPI.Feature.LateUpdate"/> method.
/// </summary>
/// <remarks>
/// <list>
/// <item>Used to decorate a method on a <see cref="FeaturesAPI.Feature"/> type.</item>
/// <item>The method <b>must NOT</b> be <c>static</c> and have no parameters.</item>
/// <item>Alternatively, name your method <c>LateUpdate</c> to avoid having to use this attribute.</item>
